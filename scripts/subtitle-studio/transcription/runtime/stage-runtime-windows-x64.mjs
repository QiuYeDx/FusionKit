...
export async function stageWindowsX64Runtime(options) {
  ...
  return withRuntimePublication(outputParent, async ({ partialRoot, finalRoot, publish }) => {
    ...
    for (const input of [...whisperInputs, ...mediaInputs]) {
      ...
      await copyRuntimeArtifact(input.inputPath, outputPath);
    ...
    const manifest = {
      ...
      manifestId: "subtitle-studio-runtime-win32-x64-v1",
    ...
    return {
      ...
      productionDecisionId: "subtitle-studio-t07-windows-runtime-v1",
      privacy: {
