...
const DEFAULT_OUTPUT_PATH =
  "/tmp/fusionkit-subtitle-studio-overwrite-test-napi-v8-darwin-arm64.node";
...
export async function buildTestMacosArm64OverwriteAddon(options = {}) {
  ...
  return deepFreeze({
    ...
    build: {
      ...
      recipe:
        "scripts/subtitle-studio/transcription/overwrite-native/build-test-addon-macos-arm64.mjs",
      compileDefinitions: [
