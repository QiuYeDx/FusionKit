...
const DEFAULT_OUTPUT_PATH = path.join(
  os.tmpdir(),
  "fusionkit-subtitle-studio-overwrite-test-napi-v8-win32-x64.node",
);
...
export async function buildTestWindowsX64OverwriteAddon(options = {}) {
  if (Object.hasOwn(options, "receiptPath")) {
    throw buildError("invalid_arguments", "Fault-test builds cannot publish a production-shaped receipt.");
  }
  ...
  return deepFreeze({
    ...
    build: {
      ...receipt.build,
      recipe:
        "scripts/subtitle-studio/transcription/overwrite-native/build-test-addon-windows-x64.mjs",
      compileDefinitions: [
    ...
    artifact: {
      ...receipt.artifact,
      logicalFileName: "subtitle-studio-overwrite-test.node",
    },
