...
export const OVERWRITE_STAGING_CONTRACT_PATH = path.join(
  PROJECT_ROOT,
  "resources/subtitle-studio/transcription/manifests/subtitle-studio-overwrite-staging.v1.json",
);
...
export function parseOverwriteStagingContract(value) {
  ...
  assertEqual(
    value.component,
    "subtitle-studio-overwrite",
    "staging component",
  );
  assertEqual(
    value.developmentRuntimeRoot,
    "build/subtitle-studio-resources/transcription",
    "development runtime root",
  );
  assertEqual(value.packagedRuntimeRoot, "subtitle-studio/transcription", "packaged root");
  ...
  assertEqual(
    ...
    "subtitle-studio-overwrite.<sha256>.node",
...
export function parseOverwriteBuildReceipt(value, target) {
  ...
  assertEqual(
    ...
    "subtitle-studio-overwrite.node",
