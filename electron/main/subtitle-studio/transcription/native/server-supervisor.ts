...
const LEASE_BRAND: unique symbol = Symbol(
  "fusionkit.subtitle-studio.transcription.server-supervisor-lease",
);
const RUNTIME_PIN_BRAND: unique symbol = Symbol(
  "fusionkit.subtitle-studio.transcription.server-supervisor-runtime-pin",
);
const REQUEST_TICKET_BRAND: unique symbol = Symbol(
  "fusionkit.subtitle-studio.transcription.server-supervisor-request",
);
...
const BACKEND_EVIDENCE_BRAND: unique symbol = Symbol(
  "fusionkit.subtitle-studio.transcription.server-backend-evidence",
);
