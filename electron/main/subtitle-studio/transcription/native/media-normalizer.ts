...
import type { LocalSubtitleMediaProbeSummary } from "../../../../../src/subtitle-studio/transcription/ipc-contract";
import {
...
const OWNER_RELEASED_ABORT_REASON = Symbol(
  "fusionkit.subtitle-studio.transcription.media-owner-released",
);
const OWNER_FAULTED_ABORT_REASON = Symbol(
  "fusionkit.subtitle-studio.transcription.media-owner-faulted",
);
