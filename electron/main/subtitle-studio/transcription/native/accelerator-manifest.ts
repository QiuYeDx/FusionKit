...
import { z } from "zod";
import rawWindowsCudaManifest from "../../../../../resources/subtitle-studio/transcription/manifests/subtitle-studio-windows-cuda-pack.v1.json";
...
const EXPECTED_PACK_ID = "subtitle-studio-windows-x64-cuda-12.4-v1";
...
function validateManifestSemantics(
  ...
  if (
    ...
    manifest.staging.manifestRelativePath !==
      "manifests/subtitle-studio-windows-cuda-pack.v1.json" ||
