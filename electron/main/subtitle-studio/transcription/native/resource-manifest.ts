import { z } from "zod";
import rawStagingContract from "../../../../../resources/subtitle-studio/transcription/manifests/subtitle-studio-staging.v1.json";
import {
...
export const LOCAL_SUBTITLE_RUNTIME_MANIFEST_RELATIVE_PATH =
  "manifests/subtitle-studio-runtime.v1.json" as const;
...
const stagingContractSchema = z
  .object({
    ...
    packagedRuntimeRoot: z.literal("subtitle-studio/transcription"),
