...
import { z } from "zod";
import rawWindowsCudaManifest from "../../../../resources/speech-resources/manifests/speech-windows-cuda-pack.v1.json";
...
const EXPECTED_PACK_ID = "speech-windows-x64-cuda-12.4-v1";
...
function validateManifestSemantics(
  ...
  if (
    ...
    manifest.staging.manifestRelativePath !==
      "manifests/speech-windows-cuda-pack.v1.json" ||
