...
export function isPublicStudioChannel(channel: string) {
  return [STUDIO_CHANNELS.importSubtitle, STUDIO_CHANNELS.listDocuments, STUDIO_CHANNELS.readDocumentPage, STUDIO_CHANNELS.exportSource].some(value => value === channel);
}
