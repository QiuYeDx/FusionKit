...
| `local-subtitle-transcriber` | `PRE-001`～`PRE-006`、`CORE-001`～`CORE-004` 已完成；domain/runtime schema、resource staging、独立 preload/IPC/capability 与 renderer session runtime contract 已冻结，全量 109 files / 1034 tests 通过。Windows personal/friend profile 保持 unsigned；下一步 `NATIVE-001` | `docs/v0.2.11/local-subtitle-transcriber/local-subtitle-transcriber_execution_plan.md` |
