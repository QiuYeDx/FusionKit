...
| `local-subtitle-transcriber` | Final Design 与详细 Execution Plan 已完成；36 个实现/验收工作包均未开始，下一步仅认领 `PRE-001` 基准语料、工具链与 clean-room 证据基线 | `docs/v0.2.11/local-subtitle-transcriber/local-subtitle-transcriber_execution_plan.md` |
