...
| `local-subtitle-transcriber` | 调研与 Final Design 已完成，待评审；定位为独立的本地 GPU/Metal 批量媒体转字幕工具，尚未创建执行计划或开始实现 | `docs/v0.2.11/local-subtitle-transcriber/local-subtitle-transcriber_final_design.md` |
