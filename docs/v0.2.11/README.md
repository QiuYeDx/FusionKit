...
| `audio-toolkit-config-ux-refactor` | `PRE-R01`、`CORE-R01`、`BE-R01`、`FE-R01`、`FE-R02` 已完成；`FE-R03` 进行中，standalone ASR 竖切已完成，下一步实时字幕/双向语音与 legacy cleanup | `docs/v0.2.11/audio-toolkit/audio-toolkit-config-ux-refactor_execution_plan.md` |
