...
| `local-subtitle-transcriber` | `PRE-001`～`PRE-006`、`CORE-001`～`CORE-004`、`NATIVE-001`、`BE-001` 已完成；private session、process epoch/lease、readiness/runtime health、backend attestation 与 owner/app/update lifecycle 已闭环。聚焦 3 files / 37 tests、显式 CPU real 1/1、全量 116 passed + 2 skipped files / 1146 passed + 2 skipped tests 通过。下一步可推进 `NATIVE-002` / `MEDIA-001` / `SUB-001` / `LINK-001`；`BE-002` 依赖仍未齐 | `docs/v0.2.11/local-subtitle-transcriber/local-subtitle-transcriber_execution_plan.md` |
