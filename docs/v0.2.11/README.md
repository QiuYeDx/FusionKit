...
| `local-subtitle-transcriber` | `PRE-001`～`PRE-003` 已完成：Node 管理官方 `whisper-server` + `large-v3-q5_0` 已在 Windows CPU/CUDA 跑通现有 3 段中/日媒体，RTF、RAM/VRAM、复用、取消、backend 与 SRT/LRC 回读通过；无需 CMake/MSVC/C++ runner；下一步 `PRE-004` / `PRE-005` | `docs/v0.2.11/local-subtitle-transcriber/local-subtitle-transcriber_execution_plan.md` |
