...
| `local-subtitle-transcriber` | `PRE-001`～`PRE-006`、`CORE-001`～`CORE-004`、`NATIVE-001`、`BE-001`、`MEDIA-001`、`SUB-001`、`SUB-002` 已完成；private server、media/PCM、canonical post-processing、SRT/LRC atomic export 与 Artifact Registry 合同已冻结。SUB-002 聚焦 5 files / 94 tests、local-subtitle 23 passed + 2 skipped files / 431 passed + 2 skipped tests、全量 124 passed + 2 skipped files / 1383 passed + 2 skipped tests、TypeScript、三段 Vite test build 与 manifest/validator gate 通过。下一步可推进 `NATIVE-002` / `MODEL-001` / `LINK-001`；`BE-002` 仍等待 MODEL-001 | `docs/v0.2.11/local-subtitle-transcriber/local-subtitle-transcriber_execution_plan.md` |
