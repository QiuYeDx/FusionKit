...
| `local-subtitle-transcriber` | `PRE-001`～`PRE-006`、`CORE-001`～`CORE-004`、`NATIVE-001`、`BE-001`、`MEDIA-001`、`SUB-001`、`SUB-002`、`MODEL-001` 已完成；managed model manifest/import/load smoke 与 app-scoped ResourceJob/session runtime 已接通。MODEL 聚焦 4 files / 50 tests、local-subtitle 29 passed + 2 skipped files / 504 passed + 2 skipped tests、全量 130 passed + 2 skipped files / 1456 passed + 2 skipped tests、TypeScript、三段 Vite test build 与 manifest/validator gate 通过。下一步优先 `BE-002` 单文件 CPU → SRT Job Manager 纵向切片 | `docs/v0.2.11/local-subtitle-transcriber/local-subtitle-transcriber_execution_plan.md` |
