...
| `audio-toolkit` | Final Design 和 Execution Plan 已按全局音频配置、实时字幕、Realtime/WebRTC 双向语音、MiMo 三模型流式 TTS 范围修订；尚未进入实现；下一步建议认领 `PRE-001` | `docs/v0.2.11/audio-toolkit/audio-toolkit_execution_plan.md` |
