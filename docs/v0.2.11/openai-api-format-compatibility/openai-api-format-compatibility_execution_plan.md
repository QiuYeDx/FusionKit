...
| FIX-002 | 已完成 | 2026-08-22 | 字幕 DeepSeek Thinking 开关默认关闭 | SubtitleTranslator 页面、字幕配置 Store、任务绑定、Chat adapter、checkpoint/recovery DTO 与测试 | 17 个相关测试文件共 111 tests passed；TypeScript、i18n、diff check 通过 | docs/v0.2.11/openai-api-format-compatibility/openai-api-format-compatibility_implementation_records/2026-08-22_FIX-002_subtitle-deepseek-thinking-toggle.md | 未使用真实 API Key；未启动前端服务 |
