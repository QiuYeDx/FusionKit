...
| MODEL-002 | 已完成 | 2026-08-06 | MODEL-001/NATIVE-002 | 下载续传、VAD、删除、磁盘和 accelerator pack | MODEL-002A～D代码生命周期全部完成；真实公网VAD走完download/hash/native load/commit/resolve/delete，完整固定CUDA archive走完production guard、20个PE解包/hash/probe/atomic commit/resolve/delete，生产模型与CUDA archive固定bytes/hash复核通过 | 两项opt-in real tests各1/1；CPU/CUDA production-model smoke通过；archive/manifest与manager/resolver/attestor/VAD隔离回归6 files / 51 tests；TypeScript、manifest 0/0 | 既有MODEL-002A～D记录、`docs/v0.2.11/local-subtitle-transcriber/local-subtitle-transcriber_implementation_records/2026-08-05_MODEL-002_FE-002_managed-vad-config-panel.md`、`docs/v0.2.11/local-subtitle-transcriber/local-subtitle-transcriber_implementation_records/2026-08-06_MODEL-002_FE-002_windows-real-resource-admission-closure.md` | 代码/组件职责已完成；unknown旧版本叶名仍不猜测删除。installer生命周期归QA-003，exact NVIDIA DLL/notice与发布许可归QA-005 |
