...
`PRE-001`～`PRE-006`、`CORE-001`～`CORE-004`、`NATIVE-001`～`NATIVE-002`、`BE-001`～`BE-003`、`MEDIA-001`、`SUB-001`～`SUB-002`、`FS-TXN-001`、`MODEL-001`、`FE-001`、`FE-003`、`LINK-002`～`LINK-004`、`LINK-006`～`LINK-007`已完成。39个顶层工作包中27个已完成、8个未开始，`MODEL-002`、`FE-002`、`FE-004`与`LINK-001`进行中。下一步由`LINK-005`迁移checkpoint、RecoveryDialog、Agent recovery、renderer event与历史v1 main-only reader并完成最终cutover，`LINK-008`再接通三种后处理模式和FE-004手动入口。legacy path与`outputURL`仍保留到LINK-005全消费者回归完成。真实大文件下载、NSIS生命周期、目标GPU、CUDA分发许可、M2产品E2E、Electron窄窗口/键盘/cancel race与其余QA仍按原边界闭环；M3继续等待`MODEL-002`、`FE-002`与`FE-004`。
