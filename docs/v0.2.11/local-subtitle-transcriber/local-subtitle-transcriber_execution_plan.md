...
| FE-003 | 已完成 | 2026-08-10 | FE-001/BE-002 | 文件授权、批量队列、进度与取消 UI | `LocalSubtitleTranscriber/{index,LocalSubtitleDraftMediaList,LocalSubtitleTaskQueue,localSubtitleTranscriberModel}.tsx/ts`、Store、media/job runtime与tests；完成1～100文件draft/request、增量多次选择、snapshot batch/task列表、逐task操作、串行media probe、多音轨Radio与task-owned selection proof | 既有7 files / 142 focused tests；FIX-LIFECYCLE追加/上限/capability与路由回归纳入31 tests；TypeScript、renderer/main/preload Vite test build通过 | `docs/v0.2.11/local-subtitle-transcriber/local-subtitle-transcriber_implementation_records/2026-08-04_FE-003_batch-draft-task-queue.md`；`docs/v0.2.11/local-subtitle-transcriber/local-subtitle-transcriber_implementation_records/2026-08-04_FE-003_media-probe-track-selection.md`；`docs/v0.2.11/local-subtitle-transcriber/local-subtitle-transcriber_implementation_records/2026-08-10_FIX-LIFECYCLE-001_route-stable-runtime-and-additive-drafts.md` | 代码职责已完成；批量部分授权失败产品态、Electron窄窗口/键盘/cancel race归`QA-002`；GPU并发固定1 |
