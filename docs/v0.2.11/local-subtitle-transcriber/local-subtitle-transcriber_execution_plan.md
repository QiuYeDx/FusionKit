...
| LINK-004 | 进行中 | 2026-08-04 | LINK-003 | 普通页面与 Agent 新建任务生产者 cutover | translator page、authorized input/main registry/preload、store/execution/tests；Agent待续 | 页面新任务path-free source/target ref、main identity-bound read/register/reveal；27 files / 156 tests、TypeScript通过 | `docs/v0.2.11/local-subtitle-transcriber/local-subtitle-transcriber_implementation_records/2026-08-04_LINK-004_translator-page-producer-cutover.md` | Agent仍需main-owned `subtitleSelectionRef`/用户确认扫描；恢复扫描保留旧适配到LINK-005，不得删除`outputURL` |
...
`PRE-001`～`PRE-006`、`CORE-001`～`CORE-004`、`NATIVE-001`～`NATIVE-002`、`BE-001`～`BE-003`、`MEDIA-001`、`SUB-001`～`SUB-002`、`FS-TXN-001`、`MODEL-001`、`FE-001`、`FE-003`、`LINK-002`～`LINK-003`、`LINK-006`～`LINK-007`已完成。39个顶层工作包中26个已完成、8个未开始，`MODEL-002`、`FE-002`、`FE-004`、`LINK-001`与`LINK-004`进行中。`LINK-004`已完成普通页面的path-free producer cutover，下一步继续Agent的main-owned selection receipt与用户确认扫描，完成后再由`LINK-005`迁移恢复消费者并最终cutover，`LINK-008`最后接通三种后处理模式和FE-004手动入口。legacy path与`outputURL`仍保留。真实大文件下载、NSIS生命周期、目标GPU、CUDA分发许可、M2产品E2E、Electron窄窗口/键盘/cancel race与其余QA仍按原边界闭环；M3继续等待`MODEL-002`、`FE-002`与`FE-004`。
