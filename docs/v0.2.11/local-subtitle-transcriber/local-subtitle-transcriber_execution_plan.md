...
>
> 当前状态：39个顶层包中20个已完成、18个未开始、1个进行中。`MODEL-002A`已接通首发模型allowlisted HTTPS下载、Range续传、no-Range/validator重启、ResourceJob/IPC、跨owner同步claim、取消清理和busy delete；local-subtitle 43 files / 968 passed + 2 skipped、TypeScript、manifest 0/0与validator 17/17通过。顶层`MODEL-002`仍等待VAD、CUDA accelerator、update/rollback、启动孤儿清理与真实1.08 GB下载，故不标完成；下一步继续`MODEL-002B`，再接`FE-002`。真实模型Electron产品E2E、NSIS生命周期与M2 packaged验收仍按QA边界处理
>
...
| MODEL-002 | 进行中 | 2026-08-03 | MODEL-001/NATIVE-002 | 下载续传、VAD、删除、磁盘和 accelerator pack | 已新增model HTTPS download manager、host allowlist、part/meta resume、ResourceJob install/delete IPC、app claim、Job/Supervisor busy guard与tests；VAD/accelerator/update rollback待续 | 聚焦7 files / 145 tests；local-subtitle 43 passed + 2 skipped files / 968 passed + 2 skipped tests；TypeScript、manifest 0/0、validator 17/17、diff通过；未跑真实1.08 GB下载 | `docs/v0.2.11/local-subtitle-transcriber/local-subtitle-transcriber_implementation_records/2026-08-03_MODEL-002A_model-download-delete.md` | VAD、CUDA archive安全解包/probe、update/rollback、启动孤儿清理与真实网络/packaged验收未完成；exact NVIDIA DLL与notice仍由QA-005复核 |
