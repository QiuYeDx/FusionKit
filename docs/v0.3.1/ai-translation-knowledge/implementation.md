...
最新完成范围见文末 P1.2d：单文件/批量正式知识翻译、转写后自动使用资料、冻结追溯与资料清除保护；独立翻译器适配及校对积累尚未完成。
...
本增量沿项目避坑流程记录 FK-PIT-0159。开始开发前的 P1.2c 已按要求提交并推送 911aac3；P1.2d 新代码保留在工作区待审阅，未再次提交/推送。未运行 pnpm，未安装依赖或改动锁文件。
