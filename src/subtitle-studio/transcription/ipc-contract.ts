...
export const LOCAL_SUBTITLE_PUBLIC_INVOKE_CHANNELS = {
  probeMedia: "subtitle-studio:transcription:probe-media",
  probeRuntime: "subtitle-studio:transcription:probe-runtime",
  previewBackend: "subtitle-studio:transcription:preview-backend",
  listManagedResources: "subtitle-studio:transcription:list-managed-resources",
  startResourceInstall: "subtitle-studio:transcription:start-resource-install",
  cancelResourceJob: "subtitle-studio:transcription:cancel-resource-job",
  deleteManagedResource: "subtitle-studio:transcription:delete-managed-resource",
  getSessionSnapshot: "subtitle-studio:transcription:get-session-snapshot",
  enqueue: "subtitle-studio:transcription:enqueue",
  retryTask: "subtitle-studio:transcription:retry-task",
  retryTaskOnCpu: "subtitle-studio:transcription:retry-task-on-cpu",
  cancelBatch: "subtitle-studio:transcription:cancel-batch",
  cancelTask: "subtitle-studio:transcription:cancel-task",
  removeTask: "subtitle-studio:transcription:remove-task",
  completePostAction: "subtitle-studio:transcription:complete-post-action",
  readArtifactText: "subtitle-studio:transcription:read-artifact-text",
  revealArtifact: "subtitle-studio:transcription:reveal-artifact",
  handoffArtifact: "subtitle-studio:transcription:handoff-artifact",
  listOverwriteRecoveries: "subtitle-studio:transcription:list-overwrite-recoveries",
} as const;

export const LOCAL_SUBTITLE_PRELOAD_INTERNAL_CHANNELS = {
  registerOwnerSession: "subtitle-studio:transcription:internal:register-owner-session",
  authorizeInputFiles: "subtitle-studio:transcription:internal:authorize-input-files",
  revokeInputFile: "subtitle-studio:transcription:internal:revoke-input-file",
  selectOutputDirectory: "subtitle-studio:transcription:internal:select-output-directory",
  revokeOutputDirectory: "subtitle-studio:transcription:internal:revoke-output-directory",
  importModel: "subtitle-studio:transcription:internal:import-model",
  recoverOverwrite: "subtitle-studio:transcription:internal:recover-overwrite",
} as const;

export const LOCAL_SUBTITLE_EVENT_CHANNELS = {
  taskEvent: "subtitle-studio:transcription:task-event",
  resourceEvent: "subtitle-studio:transcription:resource-event",
} as const;
