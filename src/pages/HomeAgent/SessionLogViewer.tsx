...
const ICON_MAP: Record<AgentLogEntryType, React.ReactNode> = {
  ...
  tool_result_committed: <PackageCheck className="h-3.5 w-3.5" />,
  name_translation_plan: <Wrench className="h-3.5 w-3.5" />,
  name_translation_apply: <PackageCheck className="h-3.5 w-3.5" />,
  subtitle_recovery_scan: <Wrench className="h-3.5 w-3.5" />,
  subtitle_recovery_queue: <PackageCheck className="h-3.5 w-3.5" />,
...
const COLOR_MAP: Record<AgentLogEntryType, string> = {
  ...
  tool_result_committed: "text-purple-500",
  name_translation_plan: "text-amber-500",
  name_translation_apply: "text-purple-500",
  subtitle_recovery_scan: "text-amber-500",
  subtitle_recovery_queue: "text-purple-500",
  usage: "text-sky-500",
...
const BG_MAP: Record<AgentLogEntryType, string> = {
  ...
  tool_result_committed: "bg-purple-500/5 border-purple-500/15",
  name_translation_plan: "bg-amber-500/5 border-amber-500/15",
  name_translation_apply: "bg-purple-500/5 border-purple-500/15",
  subtitle_recovery_scan: "bg-amber-500/5 border-amber-500/15",
  subtitle_recovery_queue: "bg-purple-500/5 border-purple-500/15",
