...
function SubtitleConverter() {
  ...
  return (
    <ToolDetailLayout
      ...
      aside={
        <div id="cvt-tour-config">
          <ToolConfigPanel
            icon={Settings}
            title={t("subtitle:converter.config_title")}
          >
            {/* Target format */}
            <ToolField
              id="cvt-tour-format"
            ...
            >
              ...
              {outputMode === "custom" ? (
                <ToolOutputPathPicker
                  ...
                  selectLabel={t("subtitle:converter.fields.select_output_path")}
    ...
    >
      <ToolFileDropZone
        ...
        title={t("subtitle:converter.fields.upload_tips")}
        description={t("subtitle:converter.fields.files_only")}
        actionLabel={t("subtitle:converter.fields.select_file")}
      />
      ...
      <ToolPanel
        id="cvt-tour-queue"
        title={t("subtitle:converter.task_management")}
        badge={
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    >
                      ...
                      {task.status === TaskStatus.PENDING &&
                        `${t("subtitle:converter.task_status.pending")} · ${Math.round(
                          task.progress || 0
                        )}%`}
                ...
                <div className="mt-3 pt-3 border-t border-border/50">
                  <div className="grid grid-cols-[auto_1fr] gap-x-4 gap-y-1.5 text-xs">
                    <span className="text-muted-foreground">
                      {t("subtitle:converter.task_detail.conversion_format")}
                    </span>
                    <span>
                      {task.from} → {task.to}
                    </span>
                    ...
                    <span className="text-muted-foreground">
                      {t("subtitle:converter.task_detail.conflict_policy")}
                    </span>
                    <span>
