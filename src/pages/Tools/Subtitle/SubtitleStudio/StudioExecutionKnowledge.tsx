...
export function StudioExecutionKnowledge({ knowledge }: { knowledge: Knowledge }) {
  ...
  return <section data-testid="studio-execution-knowledge" className="min-w-0 space-y-3 border-t pt-3">
    ...
    <KnowledgeDisclosure title={t('studio:execution.knowledge_guidance')} contentClassName="space-y-2 whitespace-pre-wrap text-xs leading-5">
    ...
    {knowledge.compiled.items.slice(offset, offset + 20).map(item => <KnowledgeDisclosure key={item.entryId}
