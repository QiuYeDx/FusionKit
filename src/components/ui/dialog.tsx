...
const DialogContent = React.forwardRef<React.ElementRef<typeof DialogPrimitive.Content>, React.ComponentPropsWithoutRef<typeof DialogPrimitive.Content> & {
  ...
  /** Allows the animated scrollable shell to own presence inside the portal. */
  portal?: boolean
  ...
  return portal ? <DialogPortal data-slot="dialog-portal"><DialogOverlay />{content}</DialogPortal> : content;
});
