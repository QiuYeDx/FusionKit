...
import { planOverlapGroupReview as plan } from "../../electron/main/local-subtitle/overlap-group-review";
import type { LocalSubtitlePostProcessingWindow as Window } from "../../electron/main/local-subtitle/subtitle-post-processor";
