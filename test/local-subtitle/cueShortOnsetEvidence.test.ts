...
import {inspectShortOnsetActivity,inspectShortOnsetConsensus as consensus,inspectShortOnsetSource,inspectShortOnsetView as inspect} from '../../electron/main/local-subtitle/cue-short-onset-evidence';
function fixture(){
