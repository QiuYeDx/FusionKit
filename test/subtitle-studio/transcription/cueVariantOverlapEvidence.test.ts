import {expect,it} from 'vitest';import {inspectVariantOverlapSource as sourceCheck,inspectVariantOverlapTiming as inspect} from '../../../electron/main/subtitle-studio/transcription/native/cue-variant-overlap-evidence';
