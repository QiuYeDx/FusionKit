...
} from "../../../electron/main/subtitle-studio/transcription/native/accelerator-manager";
import { LocalSubtitleResourceJobManager } from "../../../electron/main/subtitle-studio/transcription/native/resource-job";
...
> {
  const tempRoot = await mkdtemp(
    path.join(os.tmpdir(), "fusionkit-subtitle-studio-accelerator-"),
  );
  ...
  const resourceId = "subtitle-studio-windows-x64-cuda-test-v1";
