...
} from "../../../electron/main/speech-resources/engine/accelerator-manager";
import { LOCAL_SUBTITLE_PRODUCTION_CONTRACT } from "../../../src/speech-resources/contracts";
...
} from "../../../electron/main/speech-resources/engine/filesystem-object-identity";
import { LocalSubtitleResourceJobManager } from "../../../electron/main/speech-resources/engine/resource-job";
...
describe("speech resource engine accelerator manager", () => {
  it("routes accelerator list, install and delete through the existing managed-resource API", async () => {
    ...
    const manager = new LocalSubtitleModelManager({
      ...
      smokeModel: vi.fn(async () => undefined), smokeVad: vi.fn(async () => undefined), vadManager: false,
...
function createPack(
  ...
  const pack: LocalSubtitleAcceleratorPackDefinition = Object.freeze({
    ...
    target: { platform: "win32", arch: "x64", backend: "cuda" } as const,
