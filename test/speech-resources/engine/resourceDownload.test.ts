...
describe("speech resource engine resource download", () => {
  ...
  it("retries a transient HTTP response inside the same download", async () => {
    ...
    const openResponse = vi.fn<OpenLocalSubtitleDownloadResponse>(async (): ReturnType<OpenLocalSubtitleDownloadResponse> =>
