...
} from "../../../electron/main/speech-resources/engine/accelerator-archive";
import {
  parseLocalSubtitleAcceleratorArchiveContract,
  type LocalSubtitleAcceleratorArchiveContract,
} from "../../../electron/main/speech-resources/engine/accelerator-manifest";
...
describe("speech resource engine accelerator archive", () => {
